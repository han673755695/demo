window.onload = function() {
    ...
    function readFile() {
        ...
        for (var i = 0; i < iLen; i++) {
            ...
            reader.onload = function(e) {
                ...
                result = '<div class="showdiv"><img class="left" src="/platform/images/Arrow_left.svg" /><img class="center" src="/platform/images/delete.svg" /><img class="right" src="/platform/images/Arrow_right.svg" /></div><img id="img' + currentReViewImgIndex + randomString(1) + randomString(2) + randomString(5) + '" class="showimg" src="' + this.result + '" />';
    ...
    function send() {
        ...
        $.ajax({
			...
			url: '/admin/statistics/uploadFileBase64',
			data: {'base64Data':JSON.stringify(dataArr)},
